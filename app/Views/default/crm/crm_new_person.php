      ...
      <div class="row pl-3 pr-3 pb-3">
        ...
        <div class="col-sm-4 ">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" placeholder="<?= lang('Crm.name') ?>" name="name" autocomplete="off" required>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="socialnetwork" placeholder="<?= lang('Crm.socialNetwork') ?>" name="socialnetwork" maxlength="100" autocomplete="off">
          </div>

          <div class="form-group ">
            <label class="small"><?= lang('Crm.website'); ?>: </label>
            <input type="text" class="form-control" id="web" placeholder="<?= lang('Crm.website') ?>" name="website" autocomplete="off">
          </div>
