      ...
      <div class="row pl-3 pr-3 pb-3">
        ...
        <div class="col-sm-4 ">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" placeholder="<?= lang('Crm.companyTitle') ?>" name="title" autocomplete="off" required>
          </div>

          <div class="form-group">
            <label for="phone" class="small"><?= lang('Crm.phoneOne'); ?>: </label>
            <input type="text" class="form-control" id="phone" placeholder="<?= lang('Crm.phoneOne') ?>" name="phone" maxlength="100" autocomplete="off">
          </div>
