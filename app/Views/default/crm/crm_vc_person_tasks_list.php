<div class="card rounded-0">
  <div class="card-header p-2 rounded-0 ">
    ...
    <span class="float-right">
      <a href="<?= base_url('crm/activities/tasks/new') ?>?personid=<?= $personData['id'] ?>"><i class='fas fa-plus pl-3' style='font-size:12px'></i></a>
    </span>
  ...
  <?php if ($countTasks > 5) : ?>
    ...
    <span class="text-center m-1">
      ...
      <a class="sm " href="<?= base_url('crm/unit/tasks/') ?><?= $type ?>/<?= $personData['id'] ?>"><?= lang('Crm.showAll') ?> (<?= $countTasks ?>)</a>
    </span>
