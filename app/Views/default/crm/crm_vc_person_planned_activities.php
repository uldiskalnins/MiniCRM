<div class="card rounded-0">
    <div class="card-header p-2 rounded-0 ">
        ...
        <span class="float-right">
            <a href="<?= base_url('crm/activities/emails/new') ?>?personid=<?= $personData['id'] ?>"><i class='far fa-envelope' style='font-size:12px'></i></a>
            <a href="<?= base_url('crm/activities/calls/new') ?>?personid=<?= $personData['id'] ?>"><i class='fas fa-phone pl-3' style='font-size:12px'></i></a>
            <a href="<?= base_url('crm/activities/meetings/new') ?>?personid=<?= $personData['id'] ?>"><i class='far fa-calendar-alt pl-3' style='font-size:12px'></i></a>
        </span>
